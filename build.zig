...
pub fn build(b: *std.Build) void {
    ...
    waylandScanner.addCustomProtocol(river.path("protocol/river-input-management-v1.xml"));
    waylandScanner.addCustomProtocol(river.path("protocol/river-libinput-config-v1.xml"));
    waylandScanner.addCustomProtocol(river.path("protocol/river-xkb-config-v1.xml"));
    ...
    waylandScanner.generate("river_input_manager_v1", 1);
    waylandScanner.generate("river_libinput_config_v1", 1);
    waylandScanner.generate("river_xkb_config_v1", 1);
