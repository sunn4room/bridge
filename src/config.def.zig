...
pub const mappers = [_]Binding.Mapper{
    ...
    .{ .modifiers = mod______, .trigger = .{ .keysym = .h }, .action = .{ .iterate_window_focus = .reverse } },
    .{ .modifiers = mod_shift, .trigger = .{ .keysym = .l }, .action = .{ .iterate_sticky_window_focus = .forward } },
    .{ .modifiers = mod_shift, .trigger = .{ .keysym = .h }, .action = .{ .iterate_sticky_window_focus = .reverse } },
    ...
    .{ .modifiers = mod_all__, .trigger = .{ .keysym = .l }, .action = .{ .iterate_sticky_window_order = .forward } },
    .{ .modifiers = mod_all__, .trigger = .{ .keysym = .h }, .action = .{ .iterate_sticky_window_order = .reverse } },
    ...
    .{ .modifiers = mod______, .trigger = .{ .keysym = .@"1" }, .action = .{ .change_window_focus = 1 } },
    .{ .modifiers = mod______, .trigger = .{ .keysym = .@"2" }, .action = .{ .change_window_focus = 2 } },
    .{ .modifiers = mod______, .trigger = .{ .keysym = .@"3" }, .action = .{ .change_window_focus = 3 } },
    .{ .modifiers = mod______, .trigger = .{ .keysym = .@"4" }, .action = .{ .change_window_focus = 4 } },
    .{ .modifiers = mod______, .trigger = .{ .keysym = .@"5" }, .action = .{ .change_window_focus = 5 } },
    .{ .modifiers = mod______, .trigger = .{ .keysym = .@"6" }, .action = .{ .change_window_focus = 6 } },
    .{ .modifiers = mod______, .trigger = .{ .keysym = .@"7" }, .action = .{ .change_window_focus = 7 } },
    .{ .modifiers = mod______, .trigger = .{ .keysym = .@"8" }, .action = .{ .change_window_focus = 8 } },
    .{ .modifiers = mod______, .trigger = .{ .keysym = .@"9" }, .action = .{ .change_window_focus = 9 } },
    .{ .modifiers = mod______, .trigger = .{ .keysym = .@"0" }, .action = .{ .change_window_focus = 10 } },
    .{ .modifiers = mod_shift, .trigger = .{ .keysym = .@"1" }, .action = .{ .change_output_view = 1 } },
    .{ .modifiers = mod_shift, .trigger = .{ .keysym = .@"2" }, .action = .{ .change_output_view = 2 } },
    .{ .modifiers = mod_shift, .trigger = .{ .keysym = .@"3" }, .action = .{ .change_output_view = 3 } },
    .{ .modifiers = mod_shift, .trigger = .{ .keysym = .@"4" }, .action = .{ .change_output_view = 4 } },
    .{ .modifiers = mod_shift, .trigger = .{ .keysym = .@"5" }, .action = .{ .change_output_view = 5 } },
    .{ .modifiers = mod_shift, .trigger = .{ .keysym = .@"6" }, .action = .{ .change_output_view = 6 } },
    .{ .modifiers = mod_shift, .trigger = .{ .keysym = .@"7" }, .action = .{ .change_output_view = 7 } },
    .{ .modifiers = mod_shift, .trigger = .{ .keysym = .@"8" }, .action = .{ .change_output_view = 8 } },
    .{ .modifiers = mod_shift, .trigger = .{ .keysym = .@"9" }, .action = .{ .change_output_view = 9 } },
    .{ .modifiers = mod_shift, .trigger = .{ .keysym = .@"0" }, .action = .{ .change_output_view = 10 } },
    .{ .modifiers = mod_ctrl_, .trigger = .{ .keysym = .@"1" }, .action = .{ .change_window_weight = 1 } },
    .{ .modifiers = mod_ctrl_, .trigger = .{ .keysym = .@"2" }, .action = .{ .change_window_weight = 2 } },
    .{ .modifiers = mod_ctrl_, .trigger = .{ .keysym = .@"3" }, .action = .{ .change_window_weight = 3 } },
    .{ .modifiers = mod_ctrl_, .trigger = .{ .keysym = .@"4" }, .action = .{ .change_window_weight = 4 } },
    .{ .modifiers = mod_ctrl_, .trigger = .{ .keysym = .@"5" }, .action = .{ .change_window_weight = 5 } },
    .{ .modifiers = mod_ctrl_, .trigger = .{ .keysym = .@"6" }, .action = .{ .change_window_weight = 6 } },
    .{ .modifiers = mod_ctrl_, .trigger = .{ .keysym = .@"7" }, .action = .{ .change_window_weight = 7 } },
    .{ .modifiers = mod_ctrl_, .trigger = .{ .keysym = .@"8" }, .action = .{ .change_window_weight = 8 } },
    .{ .modifiers = mod_ctrl_, .trigger = .{ .keysym = .@"9" }, .action = .{ .change_window_weight = 9 } },
    .{ .modifiers = mod_ctrl_, .trigger = .{ .keysym = .@"0" }, .action = .{ .change_window_weight = 10 } },
